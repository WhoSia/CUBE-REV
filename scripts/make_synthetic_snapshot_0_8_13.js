...
const participantToken='CR0813-LIVE-CERT-PARTICIPANT-0001';
...
const state=M.seal({
  ...
  session_id:'CR0813-LIVE-CERT-SYNTHETIC-DO-NOT-ANALYZE-001',sequence_id:sequenceId,schedule:[...schedule],cursor:28,responses,
  telemetry:[{event_id:'CR0813-LIVE-CERT-EVENT-1',type:'ENGINEERING_SYNTHETIC_SESSION',at:new Date(base).toISOString(),data:{exclude_from_human_analysis:true,certificate:'CUBE-REV-0.8.13'}}],
  post_task:{hypothesis_guess:'engineering synthetic collector and factory certification',confidence:100,deliberate_strategy_change:false,technical_notes:'DO NOT INCLUDE IN HUMAN COHORT'},
  ...
  upgrade_epoch:0,migration_provenance:null,active_session_provenance:{source_version:'CUBE-REV 0.8.12',source_schema:'CR0812-RESUME-STATE-1',source_storage_key:'cube-rev-cognitive-mode-0812-v1',source_integrity:'synthetic-fixture',source_revision:1,migrated_at:new Date(base).toISOString(),policy:'SYNTHETIC_CERT_FIXTURE_V1'}
});
...
console.log(`CR0813_SYNTHETIC_SNAPSHOT_PASS session=${snapshot.session_id} responses=${snapshot.responses.length} sha256=${hash}`);
