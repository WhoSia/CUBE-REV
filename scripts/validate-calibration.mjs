...
assert.match(host, /const BUILD_ID = '0\.7\.12-camera-neutral-bypass-hotfix-1'/);
assert.match(host, /COLLECTION ACTIVE/);
assert.match(host, /camera_trial_start_standardized/);
assert.match(host, /probe_type:'nonvisual_timing_control'/);
assert.doesNotMatch(host, /response:'neutral_acknowledged'/);
